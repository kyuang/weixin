...
<body ontouchstart>
<div class='bd'>
	<form action="/weixin_tongshi/index.php/Home/Admin/add" method="post" enctype="multipart/form-data">
...
$('.weui_uploader_input').change(function(){
   //创建FormData对象
        ...
        $.ajax({
            url:"/weixin_tongshi/index.php/Home/Admin/addfile",
            type:'POST',
            data:data,
            cache: false,
			...
			var tu = '<li class="weui_uploader_file" style="background-image:url('+"/weixin_tongshi/Public/images/"+data+')"></li>';
